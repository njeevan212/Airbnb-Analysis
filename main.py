...
if fl is not None:
        ...
        df = pd.read_csv("/home/jeeva/Projects/python/Airbnb-Analysis/Airbnb_NYC_2019.csv", encoding="ISO-8859-1")
...
with col2:
    st.subheader("Neighbourhood group Vs Price")
...
with cl1:
    with st.expander("Room type Vs Price"):
...
with cl2:
    with st.expander("Neighbourhood group Vs price"):
